    ...
    return Scaffold(
      body: isLoading
        ...
        Positioned(
          ...
          left: 10,
          right: 10,
          child: _baseUrl.isNotEmpty && meals.isNotEmpty ? MealInfoWidget(
          ...
          ) : SizedBox(), // Affiche un SizedBox lorsque _baseUrl ou meals est vide
        ),
          Positioned(
            top: 480,
            left: 10,
            ...
            child: meals.isNotEmpty ? MealCarouselWidget(meals: meals) : SizedBox(), // Vérifie si la liste n'est pas vide avant de passer meals à MealCarouselWidget
          ),
          Positioned(
            bottom: 20,
            left: 0,
